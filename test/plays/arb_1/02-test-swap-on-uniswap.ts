...
describe("2: Test Swap Funcs", function ()
{
    async function deployFixture()
    {
        ...
        return { usdcwhale, usdtwhale, daiwhale, usdc, accounts, arb, usdt, dai, weth }
    }


    describe('1) Swap USDC for DAI back to USDC', () =>
    {


        it("usdc -> dai  ", async () =>
        {
            const { usdcwhale, usdtwhale, daiwhale, usdc, accounts, arb, usdt, dai, weth } = await loadFixture(deployFixture)
