...
contract SwapExamples {
   ...
   /// @notice swapInputMultiplePools swaps a fixed amount of WETH for a maximum possible amount of DAI
        ...
        ISwapRouter.ExactInputParams memory params = ISwapRouter
            .ExactInputParams({
                path: abi.encodePacked(
                    WETH9,
                    uint24(3000), // low fee : high tvl
                    USDC,
                    uint24(100), // low fee : high tvl
                    DAI
                ),
                recipient: msg.sender,
                deadline: block.timestamp,
        ...
        returns (uint amountIn)
    {
        ...
        // The parameter path is encoded as (tokenOut, fee, tokenIn/tokenOut, fee, tokenIn) || derection in reverse
